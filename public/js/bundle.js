...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoibmljb2xhc2RhdWRpbiIsImEiOiJjbDRzYmtwb3MwMWFlM2NtejZjdm02d2hjIn0.TZwIjL2T1eZKh9nzkSpUBA';
  var map = new mapboxgl.Map({
    container: 'map',
    // put the map in an element with id of 'map'
    style: 'mapbox://styles/nicolasdaudin/cl4skbg08000016s9gkxlkwrk',
    scrollZoom: false // center: [-118.111, 34.111],
    // zoom: 6,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error logging out! Sorry! Try again!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Your ".concat(type, " have been successfully updated")); // window.setTimeout(() => {
...
var logOutBtn = document.querySelector('.nav__el--logout'); // const saveUserSettingsBtn = document.querySelector('.form-user-data .btn--api');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              userPasswordForm.querySelector('.btn--green').innerHTML = 'Saving password ... ';
              _context.next = 7;
